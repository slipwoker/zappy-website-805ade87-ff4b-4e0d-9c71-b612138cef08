document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearFieldError(field) {
      ...
      const errorEl = document.getElementById('error-' + (field.name || field.id));
      if (errorEl) {
        errorEl.textContent = '';
      }
    }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רן גולדשטיין משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '805ade87-ff4b-4e0d-9c71-b612138cef08',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '805ade87-ff4b-4e0d-9c71-b612138cef08';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '805ade87-ff4b-4e0d-9c71-b612138cef08';
